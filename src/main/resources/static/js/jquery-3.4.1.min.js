    ...
    var h = function (n) {
        var e, d, b, o, i, h, f, g, w, u, l, T, C, a, E, v, s, c, y, k = "sizzle" + 1 * new Date, m = n.document, S = 0,
            ...
            U = new RegExp(M + "|>"), X = new RegExp($), V = new RegExp("^" + I + "$"), G = {
                ...
                ATTR: new RegExp("^" + W),
                PSEUDO: new RegExp("^" + $),
                CHILD: new RegExp("^:(only|first|last|nth|nth-last)-(child|of-typeName)(?:\\(" + M + "*(even|odd|(([+-]|)(\\d*)n|)" + M + "*(?:([+-]|)" + M + "*(\\d+)|))" + M + "*\\)|)", "i"),
                bool: new RegExp("^(?:" + R + ")$", "i"),
        ...
        for (e in d = se.support = {}, i = se.isXML = function (e) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    var y = "nth" !== h.slice(0, 3), m = "last" !== h.slice(-4), x = "of-typeName" === e;
        ...
        }) || fe("typeName|href|height|width", function (e, t, n) {
